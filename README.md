...
`IntelliJ IDEA` - IDE, используемая для разработки проекта
`Java` - язык программирования, на котором реализован проект
`Gradle` - система сборки проекта
`Junit5` - фреймворк, с помощью которого реализованы тесты
`Selenide` - фреймворк, с помощью котрого реализованы UI-тесты
`REST-assured` - фреймворк, с помощью которого реализованы API-тесты
`Appium` - фреймворк, с помощью которого реализованы тесты для мобильного приложения
`Selenoid` - инструмент для удаленного запуска браузера в Docker контейнерах
`Browserstack` - удаленная ферма, на устройствах которой испытывались тесты для мобильного приложения
`Android Studio` - инструмент, с помощью которого запускался эмулятор мобильного устройства с мобильным приложением
`Jenkins` - CI/CD для удаленного запуска тестов
`Allure Report` - инструмент для логирования и анализа результатов работы тестов
`Allure TestOps` - инструмент для логирования и анализа результатов работы тестов
`Telegram` - инструмент для логирования и анализов результатов работы тестов
`Jira` - система багтрекинга для хранения тест кейсов
